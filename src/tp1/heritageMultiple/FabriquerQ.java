...
public class FabriquerQ {
	public static final FabriqueRationnels<Q> SYMBOLIQUE_MUTABLE = new QSymboliqueParFractionMutable();
	public static final FabriqueRationnels<Q> SYMBOLIQUE_IMMUTABLE = new QSymboliqueParFraction();
	public static final FabriqueRationnels<Q> EFFICACE_MUTABLE = new QEfficaceParQuotientMutable();
	public static final FabriqueRationnels<Q> EFFICACE_IMMUTABLE = new QEfficaceParQuotient();
